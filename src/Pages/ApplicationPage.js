				...
				<Grid container spacing={2}>
					<Grid item>
						...
						<Typography variant='body2' color='initial'>
							Particulars regarding ources of income of should be stated in
							full. Particulars of income supplied by you will be checked with
							relevant officers and the Department of Inland revenue. <br />{' '}
							<br />
							No feilds should be left blank. If you have nothing to state it
							...
							are not channeled through Grama Sevaka and Divisional Seceretary
							will be rejected. <br /> <br />
							This application should beduly perfected and handed over to Grama
							Sevaka, so as to reach this office on or before 30th of September
							2020 the Grama Sevaka will forward the pplication to the Division
							Seceratry as specified in cage 11. As the application has to be
							returned by regidtered post and envelop of 9”x 4” in size with
							...
							If the Jaffna Univsersity authorities are convinced that the
							...
							gaurdian (chief priest of the temple) <br /> <br />
							If you are under the custody of a legal Gaurdian you should
					...
					<Grid item xs={12} sm={4}>
						<TextField
							...
							label='Index Number'
							placeholder='S XXXXX'
							helperText='If not provided, contact your relevent Dept.'
						/>
					</Grid>
					<Grid item xs={12} sm={4}>
					...
					<Grid item xs={12} sm={6} md={4}>
						<TextField
							...
							helperText='State your permenant Address here.'
						/>
					</Grid>
					<Grid item xs={12} sm={6} md={4}>
					...
					<Grid item xs={12} sm={6} md={4}>
						<FormControl size='small' variant='outlined' fullWidth>
							<InputLabel id='grama-sevaka-divison'>
								Grama-Sevaka Division
							</InputLabel>
							<Select
								labelId='grama-sevaka-divison'
								id='grama-sevaka-divison'
								value='Pathadumbara'
								label='Grama-Sevaka Divison'
							>
					...
					<Grid item xs={12} sm={6} md={4}>
						<FormControl size='small' variant='outlined' fullWidth>
							<InputLabel id='grama-sevaka-divison-no'>
								Grama-Sevaka Division No.
							</InputLabel>
							<Select
								labelId='grama-sevaka-divison-no'
								id='grama-sevaka-divison-no'
								value='#GS10119'
								label='Grama-Sevaka Divison No.'
							>
